 ...
 */
class CRM_Sepacontributionautofill_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Sepacontributionautofill_Upgrader(
        'net.gellweiler.sepacontributionautofill',
        realpath(__DIR__ .'/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Sepacontributionautofill_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
